...
@section('content')
                            ...
                            @forelse($models_display as $index => $model)
                                <tr class="even:bg-gray-100 hover:bg-[#FEE5E5] transition-colors duration-200">
                                    ...
                                    <td class="text-center border border-gray-200">
                                        ...
                                        <button onclick="openDeleteModal('{{ route('models.destroy', $model->id) }}')" class="btn btn-sm border-2 border-[#ef4444]/50 hover:bg-red-700 text-black px-2" title="Delete">🗑️</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
    ...
    <dialog id="delete_confirm_modal" class="modal backdrop-blur-lg bg-black/10">
        <div class="modal-box max-w-sm rounded-lg border border-white/40 shadow-2xl bg-white text-center">
            ...
            <p class="text-sm text-gray-700 mb-6">Are you sure you want to delete this model? This action cannot be undone.</p>
